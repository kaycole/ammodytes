...
# p
# ########
tiff("Figure6.tiff", units="in", width=10, height=10, res=300)

ggplot(AMMO_geoarea, aes(reorder(comname,relmsw),relmsw,fill=geoarea))+
  geom_col()+
  geom_errorbar(aes(ymin=relmsw-relci, ymax=relmsw+relci), width=.5)+
...
tiff("Figure5.tiff", units="in", width=10, height=10, res=300)

ggplot(AMMO_season, aes(reorder(comname,relmsw),relmsw,fill=season))+
  geom_col()+
  geom_errorbar(aes(ymin=relmsw-relci, ymax=relmsw+relci), width=.5)+
...
tiff("Figure7.tiff", units="in", width=10, height=10, res=300)

ggplot(AMMO_decade, aes(reorder(comname,relmsw),relmsw,fill=decade))+
  geom_col()+
  geom_errorbar(aes(ymin=relmsw-relci, ymax=relmsw+relci), width=.5)+
